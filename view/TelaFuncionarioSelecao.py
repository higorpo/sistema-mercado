...
class TelaFuncionarioSelecao(AbstractTela):
    def __init__(self, controlador):
        sg.ChangeLookAndFeel('Reddit')

        super().__init__(controlador, nome_tela='Funcionário')

    def init_components(self, data):
        headings = ['Código', 'Nome', 'E-mail', 'Telefone', 'CPF', 'Endereço']

        layout = super()\
            .layout_tela_lista(headings=headings, values=data, modulo_nome='funcionario', btn_cadastrar_enabled=False, btn_deletar_enabled=False, btn_editar_enabled=False)
